    ...
    <>
      ...
      <div className="relative">
        ...
        <nav
          ...
          className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-3 sm:px-4 md:px-8 lg:px-10 transition-all duration-300
            ${scrolled
              ? "h-12 sm:h-14 bg-[#002954]/95 backdrop-blur-md shadow-lg shadow-black/30"
              : "h-14 sm:h-16 bg-gradient-to-r from-[#003a75] via-[#004080] to-[#002954] shadow-md"
            }`}
        >
          {/* Logo + Full Shop Name */}
          <Link to="/" aria-label="Shree Balajee Printing & Flex — Home" className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <img
              src={logo}
              alt="Shree Balajee Printing & Flex logo"
              width={32} height={32}
              className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 rounded-full object-cover border-2 border-blue-700 shadow-md hover:scale-105 transition-transform duration-300 flex-shrink-0"
            />
            <div className="leading-tight">
              {/* Full Shop Name - Responsive font sizes */}
              <p className="text-yellow-300 font-extrabold uppercase tracking-wider whitespace-nowrap"
                 style={{ fontSize: "clamp(0.7rem, 3.5vw, 0.9rem)" }}>
                Shree Balajee
              </p>
              <p className="text-yellow-400/80 font-semibold uppercase tracking-[0.1em] whitespace-nowrap"
                 style={{ fontSize: "clamp(0.55rem, 2.8vw, 0.75rem)" }}>
                Printing & Flex
              </p>
            </div>
          </Link>
          ...
          {/* Desktop Nav Links */}
          <ul className="hidden lg:flex items-center gap-6 xl:gap-8 list-none m-0 p-0" role="menubar">
            {NAV_LINKS.map((link) => (
              <li key={link.label} role="none">
                <a
                  href={link.href}
                  role="menuitem"
                  className="relative text-white/90 hover:text-yellow-300 font-bold text-xs xl:text-sm uppercase tracking-wider group transition-colors duration-200"
                >
                  {link.label}
          ...
          {/* Right side - Mobile Order Now + Desktop CTA + Hamburger */}
          <div className="flex items-center gap-1 sm:gap-2">
            
            {/* Mobile Order Now Button */}
            <Link
              to="/order"
              className="lg:hidden flex items-center gap-1 bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-extrabold text-[10px] sm:text-xs uppercase tracking-wider px-2.5 py-1.5 sm:px-3 sm:py-1.5 rounded-lg shadow-md transition-all duration-200"
            >
              <BagIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
              <span>Order</span>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-2 xl:gap-3">
              <a
                ...
                className="flex items-center gap-1 xl:gap-2 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-yellow-400/60 text-white font-bold text-xs xl:text-sm px-3 xl:px-4 py-1.5 xl:py-2 rounded-full transition-all duration-200"
              >
                <PhoneIcon />
              ...
              <Link
                ...
                className="flex items-center gap-1 xl:gap-2 bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-extrabold text-xs xl:text-sm uppercase tracking-widest px-3 xl:px-5 py-1.5 xl:py-2.5 rounded-lg shadow-lg hover:-translate-y-0.5 hover:shadow-yellow-400/40 transition-all duration-200"
              >
                <BagIcon />
                <span>Order Now</span>
              </Link>
            ...
            <button
              ...
              className="lg:hidden flex flex-col justify-center items-center w-8 h-8 sm:w-9 sm:h-9 gap-[4px] sm:gap-[5px] bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition-all duration-200"
            >
              <span className={`block w-3.5 sm:w-4 h-[2px] sm:h-[2.5px] bg-yellow-300 rounded-full transition-all duration-300 origin-center ${isMobileMenuOpen ? "rotate-45 translate-y-[6px] sm:translate-y-[7.5px]" : ""}`} />
              <span className={`block w-3.5 sm:w-4 h-[2px] sm:h-[2.5px] bg-yellow-300 rounded-full transition-all duration-300 ${isMobileMenuOpen ? "opacity-0 scale-x-0" : ""}`} />
              <span className={`block w-3.5 sm:w-4 h-[2px] sm:h-[2.5px] bg-yellow-300 rounded-full transition-all duration-300 origin-center ${isMobileMenuOpen ? "-rotate-45 -translate-y-[6px] sm:-translate-y-[7.5px]" : ""}`} />
            </button>
          </div>
        </nav>
        ...
        {/* HERO SECTION */}
        <div className="pt-14 sm:pt-16 bg-white px-3 sm:px-5 lg:px-8 py-3 sm:py-4 mt-2">
          <div className="relative w-full overflow-hidden rounded-2xl" style={{ height: "clamp(200px, 42vw, 420px)" }}>
            <img
              src={flex_mac}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-end text-center px-4 pb-6 sm:pb-10 w-full">
              ...
              <h1 className="text-yellow-300 font-black uppercase tracking-wide leading-none mb-1 sm:mb-2 drop-shadow-2xl" style={{ fontSize: "clamp(1.3rem, 6vw, 4.5rem)" }}>
                SHREE BALAJEE
              </h1>

              <p className="text-white font-semibold uppercase tracking-[0.2em] sm:tracking-[0.25em] mb-3 sm:mb-6" style={{ fontSize: "clamp(0.6rem, 2vw, 1.2rem)" }}>
              ...
              <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
                <Link
                  to="/order"
                  aria-label="Place your order"
                  className="flex items-center gap-1.5 bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-extrabold text-[11px] sm:text-sm uppercase tracking-widest px-3 sm:px-6 py-1.5 sm:py-3 rounded-xl shadow-xl hover:-translate-y-0.5 hover:shadow-yellow-400/40 transition-all duration-200"
                >
                  <BagIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                  Order Now
                </Link>
                <a href="#services" aria-label="View our printing services" className="flex items-center gap-1.5 bg-white/10 hover:bg-white/20 border border-white/35 text-white font-bold text-[11px] sm:text-sm uppercase tracking-widest px-3 sm:px-6 py-1.5 sm:py-3 rounded-xl backdrop-blur-sm hover:-translate-y-0.5 transition-all duration-200">
                  Our Services
                </a>
              </div>
            </div>
